...
var RedisPackageStore = require('./redis-package-store');
...
var options = {};
var RedisDb = require('./db/redis').RedisDb;

var port = process.env.PORT || 5678; //3100;
...
function _init() {
    ...
    _packageStore = new RedisPackageStore({
